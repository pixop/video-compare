...
ifeq ($(findstring CYGWIN_NT-10.0, $(shell uname)), CYGWIN_NT-10.0)
  ...
  CXXFLAGS += -Iffmpeg-7.0-full_build-shared/include/ -ISDL2-devel-2.28.5-mingw/SDL2-2.28.5/x86_64-w64-mingw32/include/
  LDLIBS = -Lffmpeg-7.0-full_build-shared/lib/ -LSDL2-devel-2.28.5-mingw/SDL2-2.28.5/x86_64-w64-mingw32/lib/
else
  CXX = g++
  LDLIBS = -pthread
endif
