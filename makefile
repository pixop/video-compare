...
ifeq ($(findstring CYGWIN_NT-10.0, $(shell uname)), CYGWIN_NT-10.0)
  ...
  CXXFLAGS += -Iffmpeg-5.1.2-full_build-shared/include/ -ISDL2-devel-2.26.4-mingw/SDL2-2.26.4/x86_64-w64-mingw32/include/
  LDLIBS = -Lffmpeg-5.1.2-full_build-shared/lib/ -LSDL2-devel-2.26.4-mingw/SDL2-2.26.4/x86_64-w64-mingw32/lib/ -lavformat -lavcodec -lavfilter -lavutil -lswresample -lswscale -lSDL2 -lSDL2_ttf
else
  CXX = g++
