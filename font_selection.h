...
[[nodiscard]] std::string format_custom_font_open_error(const std::string& path, int point_size, const char* text_role, const char* ttf_error);

[[nodiscard]] TTF_Font* open_ui_font_at_size(const FontSelection& selection, EmbeddedFont active_embedded_font, int point_size, const char* text_role);
...
[[nodiscard]] EmbeddedFont resolve_auto_embedded_font(TTF_Font* scp_probe_font, const std::string& left_label, const std::string& right_label, bool* malformed_utf8_out = nullptr);
