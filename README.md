...
Compare an AV1 video against itself with and without film grain synthesis applied (requires `libdav1d`):

    video-compare input_av1.mkv __ --right-decoder libdav1d:export_side_data=film_grain
