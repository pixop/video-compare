...
VideoCompare::VideoCompare(const VideoCompareConfig& config)
  ...
  display_ = std::make_unique<Display>(config_.display_number, config_.display_mode, config_.verbose, config_.fit_window_to_usable_bounds, config_.high_dpi_allowed, config_.ui_scale, config_.font_selection, config_.aspect_lock_mode, config_.aspect_view_mode,
