  ...
  try {
    argagg::parser argparser{
        {{"help", {"-h", "--help"}, "print help and exit", 0},
         ...
         {"aspect-view-mode",
          {"-x", "--aspect-view-mode"},
          "initial aspect view mode: 'stretch' (default), 'original' (shared canvas), 'dynamic' (current reference video display aspect; original left input remains the reference after visual swap), '16:9', '4:3', or '1:1'",
          1},
